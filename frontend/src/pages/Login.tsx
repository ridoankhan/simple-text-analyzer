  ...
  return (
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">TextInsight</h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Advanced text analysis for everyone
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Sign in with your Google account to access your texts and analysis.
              </p>
            </div>
              ...
              <div className="mt-6 grid grid-cols-1 gap-3">
                <div className="flex items-start">
                  ...
                  <p className="ml-2 text-sm text-gray-700">
                    Analyze text for word count, character count, and more
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="ml-2 text-sm text-gray-700">
                    Save and manage your text entries
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="ml-2 text-sm text-gray-700">
                    Identify longest words and sentence structures
                  </p>
                </div>
              </div>
            </div>
